      ...
      <div className="max-w-7xl mx-auto">
        ...
        {loading ? (
          ...
          <div className="space-y-6">
            {orders.length === 0 ? (
              <div className="text-center py-12">
                <p className="text-brown/70 text-xl">No orders yet.</p>
                <p className="text-brown/50 mt-2">Orders will appear here when customers place them.</p>
              </div>
            ) : (
              orders.map((order) => (
                <div
                ...
                >
                  ...
                  <div className="flex flex-wrap gap-2">
                    <button
                      ...
                      disabled={updatingStatus === order.id || order.status === 'confirmed'}
                    ...
                    >
                      {updatingStatus === order.id ? 'Updating...' : 'Complete'}
                    </button>
