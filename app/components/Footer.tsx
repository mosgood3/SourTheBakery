        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12 mb-12">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="flex space-x-4">
              ...
              <a href="https://www.youtube.com/@sourthebakery" target="_blank" rel="noopener noreferrer" aria-label="YouTube" className="text-white hover:scale-110 transition-all duration-300">
                <FaYoutube size={24} />
              </a>
          ...
          <div>
            ...
            <div className="space-y-4">
              <div>
                ...
                <p className="text-white/70">Rocky Hill, CT 06067</p>
              </div>
              <div>
