...
export const generateOrderConfirmationHTML = (order: OrderConfirmationData): string => {
  ...
  const itemsHTML = order.items.map(item => `
    <tr style="border-bottom: 1px solid #eee;">
      <td style="padding: 12px; font-weight: 500;">${escapeHtml(item.productName)}</td>
      <td style="padding: 12px; text-align: center;">${escapeHtml(item.quantity.toString())}</td>
      <td style="padding: 12px; text-align: right;">${escapeHtml(item.price)}</td>
      ...
      <div style="max-width: 600px; margin: 0 auto; background-color: white; box-shadow: 0 4px 6px rgba(0,0,0,0.1);">
        ...
        <div style="padding: 40px 30px;">
          <div style="background-color: #f0f8f0; border-left: 4px solid #228B22; padding: 20px; margin-bottom: 30px;">
            <h2 style="margin: 0 0 10px; color: #228B22; font-size: 22px;">Thank you for your order!</h2>
          ...
          <div style="margin-bottom: 30px;">
            <h3 style="color: #228B22; border-bottom: 2px solid #32CD32; padding-bottom: 10px; margin-bottom: 20px;">Order Information</h3>
            <table style="width: 100%; border-collapse: collapse;">
              <tr>
                <td style="padding: 8px 0; font-weight: 600; color: #228B22; width: 120px;">Order #:</td>
                <td style="padding: 8px 0;">#${escapeHtml(order.orderId.slice(-8))}</td>
              </tr>
              <tr>
              ...
              <tr>
                <td style="padding: 8px 0; font-weight: 600; color: #228B22;">Total:</td>
                <td style="padding: 8px 0; font-size: 18px; font-weight: 600; color: #32CD32;">$${order.total.toFixed(2)}</td>
              </tr>
            </table>
          </div>
          ...
          <!-- Items -->
          <div style="margin-bottom: 30px;">
            <h3 style="color: #228B22; border-bottom: 2px solid #32CD32; padding-bottom: 10px; margin-bottom: 20px;">Order Items</h3>
          ...
          <div style="text-align: center; padding: 20px; background-color: #f0f8f0; border-radius: 8px;">
            <h4 style="color: #228B22; margin: 0 0 10px;">Questions about your order?</h4>
    ...
    <body style="margin: 0; padding: 0; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; background-color: #f5f5f0;">
      <div style="max-width: 600px; margin: 0 auto; background-color: white; box-shadow: 0 4px 6px rgba(0,0,0,0.1);">
        ...
        <div style="padding: 40px 30px;">
          ...
          <div style="margin-bottom: 30px;">
            <h3 style="color: #228B22; border-bottom: 2px solid #32CD32; padding-bottom: 10px; margin-bottom: 20px;">What This Means</h3>
          ...
          <div style="margin-bottom: 30px;">
            <h3 style="color: #228B22; border-bottom: 2px solid #32CD32; padding-bottom: 10px; margin-bottom: 20px;">Payment Information</h3>
            <table style="width: 100%; border-collapse: collapse;">
              <tr>
                <td style="padding: 8px 0; font-weight: 600; color: #228B22; width: 120px;">Customer:</td>
                <td style="padding: 8px 0;">${escapeHtml(customerName)}</td>
              </tr>
              <tr>
                <td style="padding: 8px 0; font-weight: 600; color: #228B22;">Email:</td>
                <td style="padding: 8px 0;">${escapeHtml(customerEmail)}</td>
              </tr>
              <tr>
                <td style="padding: 8px 0; font-weight: 600; color: #228B22;">Reference #:</td>
                <td style="padding: 8px 0;">${escapeHtml(paymentIntentId.slice(-8))}</td>
              </tr>
            </table>
          </div>
          ...
          <!-- Contact Info -->
          <div style="text-align: center; padding: 20px; background-color: #f0f8f0; border-radius: 8px;">
            <h4 style="color: #228B22; margin: 0 0 10px;">Need Immediate Assistance?</h4>
            <p style="margin: 0; color: #666;">
              Please contact us with your reference number:<br>
              Email: <a href="mailto:orders@sourthebakery.com" style="color: #32CD32; text-decoration: none;">orders@sourthebakery.com</a><br>
